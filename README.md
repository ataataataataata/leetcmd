...
- **Problem list** — paginated browsing of the full LeetCode problem set, with difficulty and paid-only indicators.
...
- **Built-in code editor** — a lightweight, syntax-aware text editor with:
  ...
  - Word-wise cursor movement (Ctrl+Left/Right style), Home/End, Page Up/Down
  - Per-language autocomplete keyword suggestions (C++, C, Java, Python, and more)
...
| Main | `q` | Quit |
| Question | `Tab` | Move cursor in editor |
